...
describe("Tabs", () => {
  it("should render the tabs component with the first tab active by default", () => {
    ...
    expect(mobileTab).toHaveClass("animate-opacity bg-base-100 shadow-sm");
  });
  ...
  it("should switch to a different tab when clicked and show the correct content", () => {
    ...
    expect(tabletTab).toHaveClass("animate-opacity bg-base-100 shadow-sm");
    const mobileTab = screen.getByText("Mobile");
    expect(mobileTab).not.toHaveClass("animate-opacity bg-base-100 shadow-sm");
